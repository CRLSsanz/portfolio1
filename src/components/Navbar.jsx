...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      ...
      <ul
        className={`fixed z-50 flex flex-col justify-center text-center text-white bg-[#0C87A7ee] top-16 w-[calc(100%-100px)] sm:w-[500px] h-[calc(100%-48px)] lg:h-[calc(100%-56px)] transform transition-all duration-1000 px-8 sm:px-12 lg:px-24
        ${
          navbar
