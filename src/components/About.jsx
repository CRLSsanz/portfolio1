        ...
        <div className="Xlg:flex Xlg:flex-row pr-2 -ml-2 sm:ml-0 sm:px-5">
          ...
          <div className="hidden Xsticky Xtop-20 Xh-full lg:block lg:basis-1/3 ml-20">
            <h2
              data-aos="zoom-in-left"
              data-aos-duration="500"
              className="relative text-3xl text-white font-medium dark:text-gray-700 mb-5"
            >
            ...
            <div className=" flex flex-wrap gap-x-2 gap-y-3 mb-10">
              <h2 className="abSkill">JavaScript</h2>
              <h2 className="abSkill">TypeScript</h2>
              <h2 className="abSkill">Html</h2>
              <h2 className="abSkill">Css</h2>
              <h2 className="abSkill">React</h2>
              <h2 className="abSkill">Vue</h2>
              <h2 className="abSkill">Next.Js</h2>
              <h2 className="abSkill">Bootstrap</h2>
              <h2 className="abSkill">Tailwind</h2>
              <h2 className="abSkill">Node.Js</h2>
              <h2 className="abSkill">Express</h2>
              <h2 className="abSkill">MongoDB</h2>
              <h2 className="abSkill">MySQL</h2>
              <h2 className="abSkill">Git</h2>
              <h2 className="abSkill">GitHub</h2>
            </div>
            ...
            <div className=" flex flex-wrap gap-x-2 gap-y-3">
              <h2 className="abSkill">Figma</h2>
              <h2 className="abSkill">Python</h2>
              <h2 className="abSkill">Postgres</h2>
              <h2 className="abSkill">AWS</h2>
              <h2 className="abSkill">PhotoShop</h2>
              <h2 className="abSkill">CorelDraw</h2>
              <h2 className="abSkill">Responsive</h2>
            </div>
          </div>
        </div>
      </div>
